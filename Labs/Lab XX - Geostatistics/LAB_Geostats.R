...
# plot all together
x11()
image(meuse.grid, col = "springgreen2")
...
# recall that we are evaluating log(zinc).
...
# We choose v.fit2, because it is smoother
...
# the target s0 will be independent of the old values.
# therefore, we can just use the mean!
