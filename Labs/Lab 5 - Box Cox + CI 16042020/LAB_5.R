...
mcshapiro.test(b)
# clearly, mshapirotest fails because y is not gaussian (le logiche della Maraaa)
...
lambda
# lambda[1] close to 1: don't need to transform it 
...
# we see that now the BC transformation of data seems gaussian!
graphics.off()
